# Power results TEMPLATE - refa - <ver> (ch.10 S8, ch.02 S6).
# Copy to power/refa/results-<ver>.md per release and fill with medians of 3 runs
...
# Calibration header: power/refa/calibration.md (must be current, <=6 months).
